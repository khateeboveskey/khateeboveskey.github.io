<template>
  <section id="contact" class="bg-accent mx-4 md:mx-8 lg:mx-32 -mb-48 mt-24 md:mt-48 p-6 md:p-12 relative flex flex-col md:flex-row gap-6 md:gap-10">
    <div class="w-full md:flex-1/2">
      ...
      <div class="space-y-4 mt-8 md:mt-10">
        <h2 class="text-lg text-white font-semibold">Or find me in</h2>
