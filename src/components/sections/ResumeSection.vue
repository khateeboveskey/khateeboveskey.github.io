	...
	<section class="bg-accent-background-muted mt-32 py-16">
		<div class="container mx-auto flex flex-col items-center gap-8 px-4 md:flex-row md:justify-between md:px-8">
			<div class="text-center md:text-left">
				...
				<h2 class="text-accent-foreground text-2xl font-bold md:text-3xl lg:text-4xl">
					Want to know more? download my resume
				</h2>
			</div>
			<a href="resume-v3.pdf" class="border-accent-foreground hover:bg-accent hover:text-accent-background hover:border-accent inline-flex items-center gap-2 border-2 px-6 py-3 text-base font-medium " rel="noopener noreferrer">
